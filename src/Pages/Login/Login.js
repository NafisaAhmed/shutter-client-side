...
const Login = () => {
    ...
    return (
        <div className='bg-gray-400 mb-0'>
            <Header></Header>
            <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-50 text-gray-800 mx-auto mt-10">
                ...
                <div className="my-6 space-y-4">
                    <button onClick={handleGoogleSignIn} aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-600 focus:ring-teal-600">
                ...
                <form onSubmit={handleLogin} className="space-y-8 ng-untouched ng-pristine ng-valid">
                    ...
                    <div className="form-control mt-6">
                        <input className="btn w-full px-8 py-3 font-semibold rounded-md bg-teal-600 text-gray-50" type="submit" value="Login" />
                    </div>
                </form>
            </div>
        </div>
