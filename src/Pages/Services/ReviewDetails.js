            ...
            <div className="flex flex-col overflow-x-auto text-xs">
                <div className="flex text-left bg-gray-300">
                    <div className="flex items-center justify-center w-8 px-2 py-3 sm:p-3">
                        <input type="checkbox" name="All" className="w-3 h-3 rounded-sm accent-teal-600" />
                    </div>
                ...
                <div className="flex border-b border-opacity-20 border-gray-300 bg-gray-50">
                    <div className="flex items-center justify-center w-8 px-2 py-3 sm:p-3">
                        <input type="checkbox" className="w-3 h-3 rounded-sm accent-teal-600" name="Box0" />
                    </div>
                ...
                <div className="flex border-b border-opacity-20 border-gray-300 bg-gray-50">
                    <div className="flex items-center justify-center w-8 px-2 py-3 sm:p-3">
                        <input type="checkbox" className="w-3 h-3 rounded-sm accent-teal-600" name="Box1" />
                    </div>
                    <div className="w-32 px-2 py-3 sm:p-3">
                        <p>Katherine Rojas</p>
                    </div>
                ...
                <div className="flex border-b border-opacity-20 border-gray-300 bg-gray-50">
                    <div className="flex items-center justify-center w-8 px-2 py-3 sm:p-3">
                        <input type="checkbox" className="w-3 h-3 rounded-sm accent-teal-600" name="Box2" />
                    </div>
                    <div className="w-32 px-2 py-3 sm:p-3">
                ...
                <div className="flex border-b border-opacity-20 border-gray-300 bg-gray-50">
                    <div className="flex items-center justify-center w-8 px-2 py-3 sm:p-3">
                        <input type="checkbox" className="w-3 h-3 rounded-sm accent-teal-600" name="Box3" />
                    </div>
                    <div className="w-32 px-2 py-3 sm:p-3">
                        <p>Keaton Collins</p>
                    </div>
                ...
                <div className="flex border-b border-opacity-20 border-gray-300 bg-gray-50">
                    <div className="flex items-center justify-center w-8 px-2 py-3 sm:p-3">
                        <input type="checkbox" className="w-3 h-3 rounded-sm accent-teal-600" name="Box4" />
                    </div>
                    <div className="w-32 px-2 py-3 sm:p-3">
                        <p>Ana Stevenson</p>
                    </div>
                ...
                <div className="flex border-b border-opacity-20 border-gray-300 bg-gray-50">
                    <div className="flex items-center justify-center w-8 px-2 py-3 sm:p-3">
                        <input type="checkbox" className="w-3 h-3 rounded-sm accent-teal-600" name="Box5" />
                    </div>
                    <div className="w-32 px-2 py-3 sm:p-3">
                        <p>Elliott Mejia</p>
                    </div>
                ...
                <div className="flex border-b border-opacity-20 border-gray-300 bg-gray-50">
                    <div className="flex items-center justify-center w-8 px-2 py-3 sm:p-3">
                        <input type="checkbox" className="w-3 h-3 rounded-sm accent-teal-600" name="Box6" />
                    </div>
                    <div className="w-32 px-2 py-3 sm:p-3">
                        <p>Riley Nunez</p>
                    </div>
                ...
                <div className="flex border-b border-opacity-20 border-gray-300 bg-gray-50">
                    <div className="flex items-center justify-center w-8 px-2 py-3 sm:p-3">
                        <input type="checkbox" className="w-3 h-3 rounded-sm accent-teal-600" name="Box7" />
                    </div>
                    <div className="w-32 px-2 py-3 sm:p-3">
                        <p>Garret Ramsey</p>
                    </div>
                ...
                <div className="flex border-b border-opacity-20 border-gray-300 bg-gray-50">
                    <div className="flex items-center justify-center w-8 px-2 py-3 sm:p-3">
                        <input type="checkbox" className="w-3 h-3 rounded-sm accent-teal-600" name="Box8" />
                    </div>
                    <div className="w-32 px-2 py-3 sm:p-3">
                        <p>Brittney Hill</p>
                    </div>
                ...
                <div className="flex border-b border-opacity-20 border-gray-300 bg-gray-50">
                    <div className="flex items-center justify-center w-8 px-2 py-3 sm:p-3">
                        <input type="checkbox" className="w-3 h-3 rounded-sm accent-teal-600" name="Box9" />
                    </div>
                    <div className="w-32 px-2 py-3 sm:p-3">
                        <p>Kendall Valdez</p>
                    </div>
                ...
                <div className="flex border-b border-opacity-20 border-gray-300 bg-gray-50">
                    <div className="flex items-center justify-center w-8 px-2 py-3 sm:p-3">
                        <input type="checkbox" className="w-3 h-3 rounded-sm accent-teal-600" name="Box10" />
                    </div>
                    <div className="w-32 px-2 py-3 sm:p-3">
                ...
                <div className="flex border-b border-opacity-20 border-gray-300 bg-gray-50">
                    <div className="flex items-center justify-center w-8 px-2 py-3 sm:p-3">
                        <input type="checkbox" className="w-3 h-3 rounded-sm accent-teal-600" name="Box11" />
                    </div>
                    <div className="w-32 px-2 py-3 sm:p-3">
                        <p>Kameron Waters</p>
                    </div>
